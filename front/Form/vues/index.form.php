...
class index 
{
   ...
   public function accueil() {
      ...
      echo "
      <div class='container'>
      <div class='container-header'><a href='../config.form.php'><box-icon name='left-arrow-alt' color='#ffffff'></box-icon></a><span class='header-title'>Quel type de ticket voulez-vous créer ?</span></div>
